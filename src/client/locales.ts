...
export const zh = {
  ...
  'searxng.retryCount': '重试次数', 'searxng.retryCountHint': '请求失败或没有结果时重试，范围 0–3。',
  'searxng.engines': '搜索引擎', 'searxng.enginesHint': '首次获取完整目录并测速服务端默认引擎；勾选后再次点击只测速所选引擎。可用项按延迟排序。未选择时使用 SearXNG 默认引擎。',
  'searxng.probeQuery': '引擎测速关键词', 'searxng.probe': '获取并测速', 'searxng.probing': '测速中…',
...
export const en = {
  ...
  'searxng.retryCount': 'Retry count', 'searxng.retryCountHint': 'Retry failed or empty searches from 0 to 3 times.',
  'searxng.engines': 'Search engines', 'searxng.enginesHint': 'First load the full catalog and probe only server defaults; after selecting engines, run again to probe only that selection. Available engines are sorted by latency.',
  'searxng.probeQuery': 'Engine probe query', 'searxng.probe': 'Fetch and probe', 'searxng.probing': 'Probing…',
